...
namespace Net.Pkcs11Interop.HighLevelAPI41.Factories
{
    ...
    public class MechanismParamsFactory : IMechanismParamsFactory
    {
        ...
        public ICkSp800108KdfParams CreateCkSp800108KdfParams(ulong prftype, uint counterWidthInBits, byte[] label, byte[] context, CK_SP800_108.DKM_LENGTH_METHOD dkmLengthMethod, uint dkmWidthInBits)
        {
            ...
            // 1. Counter format: width in bits (NativeULong is UInt32 for API41)
            ...
            byte[] dkmFormatBytes = new byte[8]; // 2 UInt32 values for API41
            ...
            return new CkSp800108KdfParams(ConvertUtils.UInt32ToCKM(ConvertUtils.UInt32FromUInt64(prftype)), dataParams);
        }
    }
}
